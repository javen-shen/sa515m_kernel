...
static struct usb_interface_assoc_descriptor  ecm_gsi_iad_descriptor = {
	.bLength =		sizeof(ecm_gsi_iad_descriptor),
	.bDescriptorType =	USB_DT_INTERFACE_ASSOCIATION,
	/* .bFirstInterface =	DYNAMIC, */
	.bInterfaceCount =	2,	/* control + data */
...
static struct usb_descriptor_header *ecm_gsi_fs_function[] = {
	...
	(struct usb_descriptor_header *) &ecm_gsi_iad_descriptor,
