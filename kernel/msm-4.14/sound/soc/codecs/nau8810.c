...
/*==========================================================================
  WHEN          WHO                          WHY
-----------  -----------  --------------------------------------------------
 2019/10/17   augus.xiong          support audio bring up copy from sdx55
===========================================================================*/
...
// 2019/10/17 add by Augsu.xiong,codec reg store;begin
...
//2019/10/17 add by Augsu.xiong,codec reg store;end
#if 0
...
//2019/10/17 add by Augsu.xiong for codec info;begin
			    ...
			    const struct i2c_device_id *id)
{
	...
	if (val == 0x1A) {
		#if 0
		codec = devm_kzalloc(dev,sizeof(struct codec_info), GFP_KERNEL);
		codec->codec_name = "nau8810.2-001a";
		codec->dai_name = "nau8810-hifi";
		#endif
		set_codec_info("nau8810.3-001a","nau8810-hifi");
	//	quec_set_codec_info("nau8810.2-001a", "nau8810-hifi");    
	//2019/10/17 add by Augsu.xiong for codec info;end
	} else {
