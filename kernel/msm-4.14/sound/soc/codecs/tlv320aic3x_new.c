 ...
 */
	/*==========================================================================
	  WHEN			WHO 						 WHY
	-----------  -----------  --------------------------------------------------
	 2019/10/17   augus.xiong		   support audio bring up copy form sdx55
	===========================================================================*/
...
static const struct reg_default aic3x_reg[] = {
	...
	{  16, 0x80 }, {  17, 0x11 }, {  18, 0x11 }, {  19, 0x78 },
...
static const struct reg_sequence init_reg[] = {
	/* HPOUT */
...
static const struct snd_kcontrol_new aic3x_left_pga_mixer_controls[] = {
	...
	SOC_DAPM_SINGLE_AIC3X("Line1R Switch", LINE1R_2_LADC_CTRL, 3, 0xf, 1),
	SOC_DAPM_SINGLE_AIC3X("Line2L Switch", LINE2L_2_LADC_CTRL, 3, 0xf, 1),
	SOC_DAPM_SINGLE_AIC3X("Mic3L Switch", MIC3LR_2_LADC_CTRL, 4, 0xf, 1),
	SOC_DAPM_SINGLE_AIC3X("Mic3R Switch", MIC3LR_2_LADC_CTRL, 0, 0xf, 1),
};

/* Right PGA Mixer */
static const struct snd_kcontrol_new aic3x_right_pga_mixer_controls[] = {
	SOC_DAPM_SINGLE_AIC3X("Line1R Switch", LINE1R_2_RADC_CTRL, 3, 0xf, 1),
	SOC_DAPM_SINGLE_AIC3X("Line1L Switch", LINE1L_2_RADC_CTRL, 3, 0xf, 1),
	SOC_DAPM_SINGLE_AIC3X("Line2R Switch", LINE2R_2_RADC_CTRL, 3, 0xf, 1),
	SOC_DAPM_SINGLE_AIC3X("Mic3L Switch", MIC3LR_2_RADC_CTRL, 4, 0xf, 1),
	SOC_DAPM_SINGLE_AIC3X("Mic3R Switch", MIC3LR_2_RADC_CTRL, 0, 0xf, 1),
};

/* Left PGA Mixer for tlv320aic3104 */
static const struct snd_kcontrol_new aic3104_left_pga_mixer_controls[] = {
	SOC_DAPM_SINGLE_AIC3X("Line1L Switch", LINE1L_2_LADC_CTRL, 3, 1, 0),
	SOC_DAPM_SINGLE_AIC3X("Line1R Switch", LINE1R_2_LADC_CTRL, 3, 1, 0),
	SOC_DAPM_SINGLE_AIC3X("Mic2L Switch", MIC3LR_2_LADC_CTRL, 4, 1, 0),
	SOC_DAPM_SINGLE_AIC3X("Mic2R Switch", MIC3LR_2_LADC_CTRL, 0, 1, 0),
};

/* Right PGA Mixer for tlv320aic3104 */
static const struct snd_kcontrol_new aic3104_right_pga_mixer_controls[] = {
	SOC_DAPM_SINGLE_AIC3X("Line1R Switch", LINE1R_2_RADC_CTRL, 3, 1, 0),
	SOC_DAPM_SINGLE_AIC3X("Line1L Switch", LINE1L_2_RADC_CTRL, 3, 1, 0),
	SOC_DAPM_SINGLE_AIC3X("Mic2L Switch", MIC3LR_2_RADC_CTRL, 4, 1, 0),
	SOC_DAPM_SINGLE_AIC3X("Mic2R Switch", MIC3LR_2_RADC_CTRL, 0, 1, 0),
};
			   ...
			   struct snd_soc_dai *dai)
{
	...
	printk("aic3x_hw_params:codec_clk =%d\n",codec_clk);
...
#endif
//add by barry 2019/05/17 for audio bring up
extern void set_codec_info(char * codec_name ,char * dai_name);
			   ...
			   const struct i2c_device_id *id)
{
	...
	u32 value;
	unsigned int reg;
	printk("enter into aic3x_i2c_probe.....\n");

//larryzhang-20200417: add codec reset pin
	value = of_get_named_gpio(np, "qcom,reset-gpio", 0);
	if (gpio_is_valid(value))
	{
		printk("tlv codec reset gpio =%d \n",value);
		ret = gpio_request(value, "qcom,reset-gpio");
		if(ret)
		{
...
#if 0
	quec_set_codec_info("tlv320aic3x-codec", "tlv320aic3x-hifi");	
#endif
	// for codec adaptive for sdx55
	set_codec_info("tlv320aic3x-codec.3-0018","tlv320aic3x-hifi");	
